...
const SERVICES: Service[] = [
  {
    ...
    description:
      "Diseñamos y construimos cada mueble desde cero en nuestro taller de Illescas, en estrecha colaboración contigo. Trabajamos con maderas nobles de origen sostenible y herrajes seleccionados pieza a pieza. Cada encargo pasa por una fase de bocetos, prototipo a escala cuando lo requiere la complejidad, y validación en taller antes del montaje final en tu casa, en cualquier punto entre Toledo y Madrid.",
    features: [
  ...
  },
  {
    ...
    description:
      "Diseñamos y montamos estructuras de madera certificada (GL24h, CLT, cedro, iroko) calculadas con ingeniería y ejecutadas con criterio constructivo tradicional. Resolvemos altillos, escaleras de tramo o helicoidales, pérgolas, porches y cubiertas con visibilidad estructural. Coordinamos con ingenierías, herreros y constructoras de la zona de Toledo y Madrid.",
    features: [
